...
radio = 100
aceleracion =0.5
sphere = MySphere([0,grosor+60, 0], radio)
floor = MyFloor([0, 0, 0], alto/3)
pared = MyPared([0,1,ancho/2], alto*5)
pared2 = MyPared([0,1,-ancho/2], alto*5)
pared3 = MyPared([largo/2,1,0], alto*5)
pared4 = MyPared([-largo/2,1,0], alto*5)
